          ...
          <div className="lg:col-span-8">
            ...
            <div className="mt-12 grid max-w-3xl gap-8 md:grid-cols-2">
              <Reveal i={2} as="p" className="text-[15.5px] leading-relaxed text-sage">
                Sedmý les je samota u zatopeného žulového lomu na Vysočině. Dva
                domky, hladina mezi skalami a kolem dokola jen les. Žádní
                sousedé, žádná silnice, žádné světlo kromě toho vašeho.
              </Reveal>
